...
export function UpcomingEventsSidebar() {
    ...
    const isAnyBirthdayPopupOpen = isWishPopupOpen || isSendWishPopupOpen
    ...
    return (
        <>
        <div className={isAnyBirthdayPopupOpen ? 'hidden' : 'space-y-6 animate-in fade-in slide-in-from-right duration-700'}>
